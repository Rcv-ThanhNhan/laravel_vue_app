        ...
        <div class="az-header-menu">
          ...
          <ul class="nav">
            <li class="nav-item">
              ...
              <li class="nav-item">
                <router-link :to="{name: 'register'}" class="nav-link" ><i class="fa-solid fa-user mr-2"></i> Đăng ký</router-link>
              </li>
  ...
  .az-header-menu .nav-item > .nav-link {
    ...
    .az-header-menu .nav-item > .nav-link .typcn {
      ...
      .az-header-menu .nav-item > .nav-link .typcn::before {
        width: auto; }
  .az-header-menu .nav-item > .nav-link.active {
    color: #5b47fb;
    position: relative; }
    .az-header-menu .nav-item > .nav-link.active::before {
      content: '';
      position: absolute;
      bottom: 0;
      top: 0;
